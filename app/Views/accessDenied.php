...
<div class="min-h-screen py-5 flex flex-col items-center bg-gray-100">
    ...
    <div class="w-full max-w-lg p-6 bg-white rounded-b-lg shadow-md text-center">
        ...
        <a href="<?= base_url('/'); ?>" class="px-6 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600 transition-colors duration-300 text-decoration-none">back Home</a>
    </div>
</div>
