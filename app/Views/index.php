...
<?= $this->section('content') ?>
  ...
  <div class="bg-gray-100 mx-auto px-4 py-8 flex justify-center items-center h-screen">
    <div class="px-4">
      ...
      <a class="bg-blue-200 text-blue-600 font-bold text-2xl py-6 px-6 rounded mt-8 text-decoration-none <?= service('router')->getMatchedRoute()[0] == '/create-survey' ? 'active' : ''; ?>" href="<?= base_url('create-survey'); ?>">Create Your First Survey</a>
    </div>
  </div>
